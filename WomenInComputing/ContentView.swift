...
struct ContentView: View {
    @State private var names: [String] = ["Ada Lovelace",
    ...
    var body: some View {
        VStack {
            HStack {
                ...
                Button {
                    currentIndex = (currentIndex + 1 == names.count) ? 0 : currentIndex + 1
                } label: {
            ...
            HStack {
                ...
                Button {
                    ...
                    currentIndex = nonRepeatingRandom(lastNumber: currentIndex, upperbound: names.count - 1)
